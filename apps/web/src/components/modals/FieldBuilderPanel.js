                                    ...
                                    <ScrollView showsVerticalScrollIndicator={true} contentContainerStyle={{ paddingBottom: 200 }}>
                                        {draftFields.length === 0 ? (
                                            ...
                                            draftFields.map((draft, idx) => (
                                                <View key={draft._tempId || idx} style={styles.tableRow}>
                                                    <View style={{ width: 40, alignItems: 'center' }}><MaterialCommunityIcons name="pencil-outline" size={18} color="#94a3b8" /></View>
                                                    ...
                                                    <View style={[styles.tableRowActions, { width: 80 }]}><IconButton icon="close" size={16} iconColor="#ef4444" onPress={() => removeDraftRow(idx)} style={{ margin: 0, backgroundColor: '#fff1f2' }} /></View>
                                                </View>
                                            ))
                                        )}
                                    </ScrollView>
